...
public:
              ...
              param(std::move(_param))
    {
        ...
        for(int qi = 0; qi < qn; qi++){
            ...
            paths_pub[qi] = nh.advertise<nav_msgs::Path>("/initSamplePath" + mav_name, 1);
        }
...
private:
    ...
    std::vector<ros::Publisher> paths_pub;
    ...
    void update_initTraj(){
        ...
        for (int qi = 0; qi < qn; qi++) {
            ...
            paths_pub[qi].publish(samplepath);
